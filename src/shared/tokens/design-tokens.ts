...
export const BOOK_CHAPTER_COUNT = 3
export const TOTAL_BOOK_STOPS = JOURNEY_STEP_COUNT + BOOK_CHAPTER_COUNT + 3
export const TOTAL_MOBILE_BOOK_STOPS = JOURNEY_STEP_COUNT + BOOK_CHAPTER_COUNT + 5
